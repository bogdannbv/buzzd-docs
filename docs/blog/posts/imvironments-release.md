...
However, because the latest snapshots are from 2005/2006, the code inside the `.imv` files (JS + HTML) is incompatible with the latest versions of Y!M (8 and above) ![frown](../../images/emoticons/frown.gif).
...
Four laptops, [a random PC found in an office](./100-new-audibles.md#special-thanks) and a few archives from our community members later, we managed to gather multiple, more recent, IMVs from around 2012 to 2015. ![dancing](../../images/emoticons/dancing.gif)
...
![autumn leaves](./images/imvs/autumn.png)
...
![emoticats](./images/imvs/emoticats.png)
...
![falling hearts](./images/imvs/hearts.png)
...
![fish tank](./images/imvs/fish.png)
...
![football kick](./images/imvs/football.png)
...
![garfield](./images/imvs/garfield.png)
...
![precious moments](./images/imvs/precious.png)
...
![purple leaves](./images/imvs/purple.png)
...
![snowflakes](./images/imvs/snowflakes.png)
