...
[:fontawesome-solid-download: flash-player-113300268-ax.zip](files/flash-player/flash-player-113300268-ax.zip){ .md-button .md-button--primary }
...
[:fontawesome-solid-download: flash-player-10318348-ax.zip](files/flash-player/flash-player-10318348-ax.zip){ .md-button .md-button--primary }
...
[:fontawesome-solid-download: uninstall_flash_player.exe](files/flash-player/uninstall_flash_player.exe){ .md-button .md-button--primary }  
